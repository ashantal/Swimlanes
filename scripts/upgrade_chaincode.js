...
var helper = require(path.join(__dirname, '../utils/helper.js'))('listings_local.json', logger);			//set the config file name here
...
fcw.enrollWithAdminCert(helper.makeEnrollmentOptionsUsingCert(), function (enrollErr, enrollResp) {
	if (enrollErr != null) {
		...
		var opts = {
			...
			path_2_chaincode: 'listings',										//same path used to install it
